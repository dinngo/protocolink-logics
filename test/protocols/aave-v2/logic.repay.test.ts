...
describe('Test AaveV2Repay Logic', function () {
  ...
  before(async function () {
    ...
    await utils.faucet.claim(new core.tokens.TokenAmount(core.tokens.mainnet.USDC, '10000'), user2.address);
    await utils.faucet.claim(new core.tokens.TokenAmount(core.tokens.mainnet.WETH, '100'), user2.address);
    await utils.faucet.claim(new core.tokens.TokenAmount(core.tokens.mainnet.USDC, '100'), user3.address);
    await utils.faucet.claim(new core.tokens.TokenAmount(core.tokens.mainnet.WETH, '100'), user3.address);
  ...
  const cases = [
    {
      ...
      borrow: new core.tokens.TokenAmount(core.tokens.mainnet.WETH, '1'),
