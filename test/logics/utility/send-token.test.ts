...
describe('mainnet-pb: Test Utility SendToken Logic', function () {
  ...
  before(async function () {
    ...
    await claimToken(chainId, user1.address, common.mainnetTokens.USDC, '100');
  });
  ...
  const testCases = [
    ...
    { input: new common.TokenAmount(common.mainnetTokens.ETH, '1'), balanceBps: 5000 },
    { input: new common.TokenAmount(common.mainnetTokens.WETH, '1'), balanceBps: 5000 },
    { input: new common.TokenAmount(common.mainnetTokens.USDC, '1'), balanceBps: 5000 },
  ];
