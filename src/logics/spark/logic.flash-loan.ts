...
import { Pool__factory, SparkFlashLoanCallback__factory } from './contracts';
  ...
  implements core.LogicTokenListInterface, core.LogicOracleInterface, core.LogicBuilderInterface
{
  ...
  get callbackAddress() {
    return getContractAddress(this.chainId, 'SparkFlashLoanCallback');
  }

  async calcCallbackFee(loan: common.TokenAmount) {
    const callback = SparkFlashLoanCallback__factory.connect(this.callbackAddress, this.provider);
