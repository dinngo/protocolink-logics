...
export interface CErc20Immutable extends BaseContract {
  ...
  functions: {
    ...
    _addReserves(addAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
    ...
    sweepToken(token: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    _addReserves(addAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;

    _delegateCompLikeTo(compLikeDelegatee: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    _addReserves(addAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
    ...
    sweepToken(token: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
