...
export interface LendingPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'withdraw(address,uint256,address,address)',
...
export interface LendingPool extends BaseContract {
  ...
  functions: {
    ...
    delegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
    ...
    undelegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    delegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
    ...
    undelegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    delegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
    ...
    undelegateWithdraw(delegatee: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
