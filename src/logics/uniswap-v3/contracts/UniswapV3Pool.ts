...
export interface UniswapV3Pool extends BaseContract {
  ...
  functions: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
