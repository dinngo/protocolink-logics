...
export interface MagicSeaFactory extends BaseContract {
  ...
  functions: {
    ...
    setFeeTo(_feeTo: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;

    setFeeToSetter(_feeToSetter: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;

    setOwnerFeeShare(
      newOwnerFeeShare: BigNumberish,
  ...
  estimateGas: {
    ...
    setFeeTo(_feeTo: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;

    setFeeToSetter(_feeToSetter: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;

    setOwnerFeeShare(newOwnerFeeShare: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    setFeeTo(_feeTo: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;

    setFeeToSetter(_feeToSetter: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
