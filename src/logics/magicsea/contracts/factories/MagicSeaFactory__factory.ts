...
export class MagicSeaFactory__factory {
  static readonly abi = _abi;
  static createInterface(): MagicSeaFactoryInterface {
    return new utils.Interface(_abi) as MagicSeaFactoryInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MagicSeaFactory {
    return new Contract(address, _abi, signerOrProvider) as MagicSeaFactory;
  }
}
