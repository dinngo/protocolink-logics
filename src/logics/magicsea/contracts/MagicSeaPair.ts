...
export interface MagicSeaPair extends BaseContract {
  ...
  functions: {
    ...
    setFeeAmount(newFeeAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  initialize(_token0: string, _token1: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    initialize(_token0: string, _token1: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
    ...
    setFeeAmount(newFeeAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    setFeeAmount(newFeeAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
