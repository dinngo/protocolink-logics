...
export interface CEther extends BaseContract {
  ...
  functions: {
    ...
    repayBorrowBehalf(borrower: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    repayBorrowBehalf(borrower: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>;
