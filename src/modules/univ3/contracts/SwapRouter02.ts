...
export interface SwapRouter02 extends BaseContract {
  ...
  estimateGas: {
    ...
    getApprovalType(token: string, amount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    approveMaxMinusOne(token: string, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>;

    approveZeroThenMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>;
