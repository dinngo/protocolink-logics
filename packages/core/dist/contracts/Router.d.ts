...
export declare namespace IRouter {
    ...
    type OutputStructOutput = [string, BigNumber] & {
        token: string;
        amountMin: BigNumber;
    };
    type LogicStruct = {
...
export interface Router extends BaseContract {
    ...
    functions: {
        execute(logics: IRouter.LogicStruct[], tokensReturn: PromiseOrValue<string>[], overrides?: PayableOverrides & {
    ...
    user(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        execute(logics: IRouter.LogicStruct[], tokensReturn: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
        user(overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
